...
/**
 * Clase DAO para manejar las operaciones de base de datos relacionadas con las
 * entidades de tipo {@link Actividad}. Utiliza el patrón Singleton para
 * asegurar una única instancia de conexión y acceso a la base de datos.
 * 
...
public class DaoActividad {
	 ...
	 * @throws SQLException Si ocurre un error al crear la instancia o al obtener la
	 *                      conexión.
	 */
	// Singelton
	...
	/**
	 * Lista todas las actividades disponibles en la base de datos y las devuelve en
	 * formato JSON.
	 * 
	 * @return Una cadena JSON que representa la lista de todas las actividades.
	 * @throws SQLException Si ocurre un error al recuperar los datos o al
	 *                      convertirlos a JSON.
	 */
	...
	/**
	 * Elimina una actividad de la base de datos utilizando su código de actividad
	 * como identificador.
	 * 
	 ...
	 * Directamente le paso la query PreparedStatement ps =
	 * con.prepareStatement("SELECT cod_actividad, nombreA, tema FROM actividades");
	 * ResultSet rs = ps.executeQuery(); //Array que devuelve ArrayList<Actividad>
	 * actividades = null; while (rs.next()) { //inicializar actividades if
	 * (actividades == null) { actividades = new ArrayList<Actividad>(); }
	 * actividades.add(new Actividad(rs.getInt("cod_actividad"),
	 * rs.getString("nombreA"), rs.getString("tema"))); } return actividades; }
	 */
