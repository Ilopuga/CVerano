 ...
 * las entidades de tipo {@link Administrador} Implementa el patrón Singleton
 * para asegurar una única instancia de la conexión a la base de datos.
 * 
...
public class DaoAdministrador {
	 ...
	 * @return Administrador si las credenciales son correctas, null en caso
	 *         contrario.
	 * @throws SQLException Si ocurre un error durante la consulta.
	 */
	...
	/**
	 * Lista todos los administradores registrados en la base de datos y devuelve
	...
	/**
	 * Verifica si existe un administrador con el nombre de usuario dado. Este
	 * método consulta la base de datos para comprobar si ya existe un registro con
