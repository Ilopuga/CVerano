...
public class Filtro implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		HttpServletRequest req = (HttpServletRequest) request; // Solicitud que llega del servidor
		HttpServletResponse res = (HttpServletResponse) response; // Respuesta al cliente
	...
	/*
	 * @Override public void destroy() { // Limpiar recursos si es necesario. }
	 */
}